 ...
 */
class TEditorHtml2 extends TField implements AdiantiWidgetInterface
{
    private   $exitAction;
    ...
    public function show()
    {
      ...
      //  TScript::create( " tinymce.init({ selector: '{$this->id}'}); " );
        // show the tag
        $this->tag->show();

        $options = '';

        TScript::create( " tinymce.init({ selector: '#{$this->id}', height : 150, language: 'pt_BR', menubar: 'file edit view insert format tools table help', plugins: 'print preview paste importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount imagetools textpattern noneditable help charmap quickbars emoticons'}); " );
    }
