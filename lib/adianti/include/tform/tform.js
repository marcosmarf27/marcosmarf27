        ...
        if (single_field.length || array_field.length) {
            ...
            if (Adianti.formEventsCounter == 0 ) {
                if (single_field.length) {
                    ...
                    // console.log(single_field.attr('id'));
                     //console.log(single_field.val());
                     //tinymce.activeEditor.setContent(single_field.val());
                     tinymce.get(single_field.attr('id')).setContent(value);
